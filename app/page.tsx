      ...
      <div className="relative isolate pt-14 dark:bg-gray-900">
        ...
        >
          <div
            ...
            style={{
              clipPath: 
                'polygon(74.1% 44.1%, 100% 61.9%, 97.5% 26.9%, 85.5% 0%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
            }}
          />
        </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <Link
                  href="/chat"
                  className="rounded-md bg-indigo-600 px-3.5 py-3.5 text-sm font-semibold text-white dark:text-white shadow-sm 
